...
residuals_data.to_csv('residuals.csv', index=False)
...
metrics_data.to_csv('evaluation_metrics.csv', index=False)

# Save Actual vs Predicted Prices to CSV
actual_vs_predicted = pd.DataFrame({
    'Date': test_dates,
    'Actual Prices': y_test_rescaled.flatten(),
    'Predicted Prices': y_pred_rescaled.flatten()
})
actual_vs_predicted.to_csv('actual_vs_predicted_prices.csv', index=False)